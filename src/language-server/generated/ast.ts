...
export interface RechenbrettSpreadsheetAstType {
    Greeting: Greeting
    Model: Model
    Person: Person
}

export class RechenbrettSpreadsheetAstReflection extends AbstractAstReflection {
...
export const reflection = new RechenbrettSpreadsheetAstReflection();
